...
async function seed() {
  try {
    ...
    const author1 = seededUsers.find((u) => u.email === "marco@example.com")!;
    const author2 = seededUsers.find((u) => u.email === "emma@example.com")!;
    ...
    const recipesWithRelations = [
      {
        ...
        authorAvatar: author1.avatar,
        authorBio: author1.bio,
      ...
      },
      {
        ...
        authorAvatar: author2.avatar,
        authorBio: author2.bio,
